...
export class App {
  ...
  readonly authOpen = signal(false); readonly authVersion = signal(0); readonly authTab = signal<'login' | 'register'>('login'); readonly authLoading=signal(false); readonly avatarPreview=signal(''); readonly authError=signal('');
