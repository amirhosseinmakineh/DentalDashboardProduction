...
@Component({
  ...
  template: `
    <section class="mobile-app-layout">
      <header class="app-topbar"><button class="icon-btn" (click)="drawerOpen.set(true)"><i class="fa-solid fa-bars" aria-hidden="true"></i></button><div><small>{{ role }}</small><h1>{{ title }}</h1></div></header>
