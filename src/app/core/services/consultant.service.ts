...
import {
  ...
  GetLeadsQuery,
  PaginatedResult,
  SetAvailableConsultantCommand,
  SetOnlineOfflineConsultantCommand,
  SubmitLeadCallReportCommand
} from '../models/consultant-lead.models';
...
export class ConsultantService {
  ...
  getLeads(query: GetLeadsQuery): Observable<PaginatedResult<ConsultantLeadDto>> {
    ...
    if (query.consultantProfileId) {
      params = params.set('consultantProfileId', query.consultantProfileId);
    }
    ...
    return this.http
      .get<PaginatedResult<ConsultantLeadDto> | ApiResponse<ConsultantLeadDto[]> | ConsultantLeadDto[]>(`${this.baseUrl}/GetLeads`, { params })
