...
export class ConsultantShellComponent {
  menu: LayoutMenuItem[]=[{label:'تکمیل پروفایل',path:'/consultant/profiles',icon:'fa-solid fa-id-card'},{label:'حضور / وضعیت آنلاین',path:'/consultant/dashboard',icon:'fa-solid fa-circle-check'},{label:'لیدهای من',path:'/consultant/leads',icon:'fa-solid fa-phone-volume'},{label:'رزروها',path:'/consultant/reservations',icon:'fa-solid fa-calendar-check'}];
}
