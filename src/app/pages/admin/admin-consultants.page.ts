...
@Component({
  ...
  template:`<section class="screen-stack admin-dashboard">
    <article class="hero-card"><small>داشبورد مدیر</small><h2>مدیریت مشاوران</h2><p>فهرست مشاوران، امتیازها، لیدها و حضور و غیاب را مدیریت کنید.</p></article>
